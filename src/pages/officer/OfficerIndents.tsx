    ...
    [key: string]: {
        ...
        quote: {
            ...
            products: Array<{
                ...
                unitPrice: string;
                totalPrice: string;
                gstPercentage?: string; // Added gstPercentage
                ...
                products: [
                    {
                        ...
                        description:
                            "High-resolution digital microscope for research",
                        quantity: "2",
                        unitPrice: "₹9,957",
                        totalPrice: "₹19,915",
                        gstPercentage: "18",
...
const OfficerIndents: React.FC = () => {
    ...
    const [selectedIndent, setSelectedIndent] = useState<AssignedIndent | null>(
        null
    );
    const [showEnquiryModal, setShowEnquiryModal] = useState(false);
    const [showComparisonChart, setShowComparisonChart] = useState(false);
    const [finalizedVendor, setFinalizedVendor] = useState<{
        [indentId: string]: string | null;
    }>({});
    const [showFinalizeModal, setShowFinalizeModal] = useState<string | null>(
        null
    );
    const [showPOModal, setShowPOModal] = useState<string | null>(null);
    const [showIndentPreview, setShowIndentPreview] = useState<string | null>(
        null
    );
    ...
    const [sentEnquiries, setSentEnquiries] = useState<{
        [indentId: string]: { form: typeof enquiryForm; pdfUrl: string };
    }>({});
    const [viewEnquiryIndentId, setViewEnquiryIndentId] = useState<
        string | null
    >(null);
    ...
    const handlePreviewPDF = () => {
        ...
        doc.text("DR. D. Y. PATIL UNIVERSITY", centerX, 15, {
            align: "center",
        });
    ...
    const handleConfirmSendEnquiry = () => {
        ...
        toast({
            title: "Enquiry Sent",
            description: `Sent to: ${
                enquiryForm.vendors.join(", ") || "No vendors"
            }`,
        });
    ...
    const handleViewQuote = (indentId: string, vendorName: string) => {
        const vendorQuote = vendorQuotes[indentId]?.find(
            (v) => v.name === vendorName
        );
        if (vendorQuote) {
    ...
    return (
        <DashboardLayout>
            ...
            {/* === Modals === */}
            <Dialog
                open={showComparisonChart}
                onOpenChange={setShowComparisonChart}
            >
                <DialogContent
                        ...
                        <div className="sticky top-0 z-20 bg-white border-b shadow-sm px-6 py-4 flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-gray-500">
                                    Detailed vendor comparison for this Purchase
                                    Order
                                </p>
                            </div>
                            <Button
               ...
               shadow-none p-0 overflow-y-auto bg-gray-100"
                >
                    <DialogHeader className="sr-only">
                        ...
                        <DialogDescription>
                            Enquiry for Indent ID: {selectedIndent?.id}
                        </DialogDescription>
                    </DialogHeader>
                    <div className="h-full flex flex-col">
                        <div className="sticky top-0 z-20 bg-white border-b shadow-sm px-6 py-4 flex items-center justify-between">
                            ...
                            <div className="bg-white rounded-lg shadow p-5">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
                                    {vendorsList.map((vendor) => (
                                        <label
                                            key={vendor}
                                            className={`flex items-center space-x-3 p-2 rounded-md border transition-all cursor-pointer ${
                                                enquiryForm.vendors.includes(
                                                    vendor
                                                )
                                        ...
                                        >
                                            <input
                                                type="checkbox"
                                                checked={enquiryForm.vendors.includes(
                                                    vendor
                                                )}
                                                onChange={(e) => {
                    ...
                    <div className="h-full flex flex-col">
                        <div className="sticky top-0 z-20 bg-white border-b shadow-sm px-6 py-4 flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-gray-500">
                                    Review the generated enquiry PDF before
                                    sending
                                </p>
                            </div>
                            <Button
                    ...
                    <div className="h-full flex flex-col">
                     ...
                     hover:bg-gray-100 hover:text-red-600 hover:border-red-300"
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-4">
                            {(
                                showFinalizeModal &&
                                vendorQuotes[showFinalizeModal]
                            )?.map((vendor: any) => (
                                <div
                                    key={vendor.name}
            ...
            <Dialog
                open={!!showPOModal}
                onOpenChange={(v) => !v && setShowPOModal(null)}
            >
                <DialogContent
                    className="w-screen h-screen max-w-none max-h-none rounded-none 
               shadow-none p-0 overflow-y-auto bg-gray-100"
                >
                    <DialogHeader className="sr-only">
                        ...
                        <DialogDescription>
                            Generate purchase order for the finalized vendor
                        </DialogDescription>
                    </DialogHeader>
                    <div className="h-full flex flex-col">
                        {/* Sticky Header */}
            ...
            <Dialog
                open={!!showIndentPreview}
                onOpenChange={(v) => !v && setShowIndentPreview(null)}
            >
                <DialogContent
                    className="w-screen h-screen max-w-none max-h-none rounded-none 
               shadow-none p-0 overflow-y-auto bg-gray-100"
                >
                    <DialogHeader className="sr-only">
                        ...
                        <DialogDescription>
                            Preview the indent details and specifications
                        </DialogDescription>
                    </DialogHeader>
                    <div className="h-full flex flex-col">
                        {/* Sticky Header */}
            ...
            {/* ✅ View Enquiry Modal */}
            <Dialog
                open={!!viewEnquiryIndentId}
                onOpenChange={(v) => !v && setViewEnquiryIndentId(null)}
            >
                <DialogContent
                    className="w-screen h-screen max-w-none max-h-none rounded-none 
               shadow-none p-0 overflow-y-auto bg-gray-100"
                >
                    <DialogHeader className="sr-only">
                        ...
                        <DialogDescription>
                            View the sent enquiry details and PDF
                        </DialogDescription>
                    </DialogHeader>
                    <div className="h-full flex flex-col">
                        {/* Sticky Header */}
                     ...
                     hover:bg-gray-100 hover:text-red-600 hover:border-red-300"
                        ...
                        <div className="flex-1 overflow-y-auto p-6">
                            {viewEnquiryIndentId &&
                                sentEnquiries[viewEnquiryIndentId] && (
                                    <>
                                                    ...
                                                    (vendorName: string) => {
                                                        const vendorDetails =
                                                            vendorContactDetails[
                                                                vendorName as keyof typeof vendorContactDetails
                                                            ];
                                                        return (
                                                            <div
                                                                key={vendorName}
            ...
            <Dialog
                open={!!showQuoteModal}
                onOpenChange={(v) => !v && setShowQuoteModal(null)}
            >
                <DialogContent
                    className="w-screen h-screen max-w-none max-h-none rounded-none 
               shadow-none p-0 overflow-y-auto bg-gray-100"
                                                            ...
                                                            >
                                                                ...
                                                                <td className="border border-gray-300 px-3 py-2">
                                                                    {(() => {
                                                                        ...
                                                                        // Format the total with Indian currency format
                                                                        ...
                                                                        if (
                                                                            ...
                                                                            return (
                                                                                <div className="bg-gray-50 px-2 py-1 rounded text-right font-medium">
                                                                                    {
                                                                                        formattedTotal
                                                                                    }
                                                                                </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="mt-1 text-lg font-semibold">
                                                    {(() => {
                                                        ...
                                                        return `₹${gstAmount.toLocaleString(
                                                            "en-IN",
                                                            {
                                                                maximumFractionDigits: 2,
                                                            }
                                            ...
                                            <div>
                                                ...
                                                {editingQuote ? (
                                                    <Input
                                                        value={
                                                            currentQuote.packingForwarding
                                                        }
                                                        onChange={(e) =>
                                                            setCurrentQuote({
                                                                ...currentQuote,
                                                ...
                                                <div className="mt-1 text-2xl font-bold text-green-600">
                                                    {(() => {
                                                        ...
                                                        const grossTotal =
                                                            ...
                                                            loading +
                                                            packing;
                                                        return `₹${grossTotal.toLocaleString(
                                                            "en-IN",
                                                            {
                                                                maximumFractionDigits: 2,
                                                            }
                        ...
                        <div className="sticky bottom-0 bg-white border-t shadow-inner px-6 py-4 flex justify-end gap-3">
                            ...
                            {editingQuote ? (
                                ...
                                <Button
                                    onClick={() =>
                                        handleEditQuote(
                                            showQuoteModal!.indentId,
                                            showQuoteModal!.vendorName
                                        )
                                    }
